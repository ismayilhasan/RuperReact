...
function UpdateColor() {
  ...
  const handleput = (event) => {
    ...
    const id = ColorId;
    const updatedColor = new FormData();
    updatedColor.append("id", ColorId);
    updatedColor.append("name", colorName);
    updatedColor.append("code", colorCode);
    axios
      .put(`https://localhost:7216/api/Categories/${id}`, updatedColor)
